        ...
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-12">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">{t('hero.stats.companies')}</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">{t('hero.stats.costReduction')}</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">{t('hero.stats.implementation')}</p>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-border/20">
            ...
            <div className="flex justify-center items-center gap-2">
              ...
              <span className="ml-3 text-sm font-medium text-foreground">{t('hero.trust.badge')}</span>
            </div>
          </div>
        </div>
      </div>
