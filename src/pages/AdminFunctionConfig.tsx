    ...
    <div className="min-h-screen bg-background">
            ...
            <div className="flex items-center gap-2 sm:gap-4 min-w-0 flex-1">
              ...
              <div className="flex items-center min-w-0">
                ...
                <div className="min-w-0">
                  <h1 className="text-sm sm:text-lg font-bold text-foreground truncate">Configuración de Funciones</h1>
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Configuración de Funciones</h2>
...
export default AdminFunctionConfig;