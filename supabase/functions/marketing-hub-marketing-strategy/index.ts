...
serve(async (req) => {
  ...
  try {
    ...
    console.log('📊 N8N Response structure:', {
      ...
      aiInsightsPreview: strategyData.ai_insights ? (Array.isArray(strategyData.ai_insights) ? `Array[${strategyData.ai_insights.length}]` : Object.keys(strategyData.ai_insights)) : 'N/A'
    });
