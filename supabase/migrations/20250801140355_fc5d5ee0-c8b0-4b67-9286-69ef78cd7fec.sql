...
{{buildera_website}}',
  'registration',
  ARRAY['buildera_name', 'buildera_logo', 'buildera_website', 'current_year', 'user_name', 'user_email', 'login_url'],
  '[]'::jsonb,
  true,
  NULL
),
...
El equipo de {{buildera_name}}',
  'password_reset',
  ARRAY['buildera_name', 'buildera_logo', 'buildera_website', 'current_year', 'user_name', 'reset_url', 'expiry_time'],
  '[]'::jsonb,
  true,
  NULL
),
...
El equipo de {{buildera_name}}',
  'periodic_report',
  ARRAY['buildera_name', 'buildera_logo', 'buildera_website', 'current_year', 'user_name', 'report_period', 'total_actions', 'new_projects', 'active_users', 'dashboard_url'],
  '[]'::jsonb,
  true,
  NULL
),
...
El equipo de {{buildera_name}}',
  'verification',
  ARRAY['buildera_name', 'buildera_logo', 'buildera_website', 'current_year', 'user_name', 'verification_url'],
  '[]'::jsonb,
  true,
  NULL
);
