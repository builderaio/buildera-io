-- Corregir completamente el trigger handle_new_user para mapear correctamente los campos
...
BEGIN
  ...
  -- IMPORTANTE: Solo insertar campos que EXISTEN en la tabla profiles
