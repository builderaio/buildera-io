-- Actualizar handle_new_user para no crear empresa automáticamente en registro social
-- Solo crear empresa cuando user_type sea 'company' Y el usuario venga de registro por email (no social)
...
BEGIN
  ...
  VALUES (
    ...
    -- Para registro social, NO usar valor por defecto de empresa
    CASE 
      WHEN is_social_signup THEN NULL
